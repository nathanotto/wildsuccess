...
function ValueOrb({ value, isSelected, onClick, size = 1 }) {
  ...
  const bottomColor = below ? "rgb(130, 95, 60)" : "rgb(120, 90, 55)";
  const topColor = abundant ? "rgb(80, 160, 220)" : "rgb(110, 180, 220)";

  const glowColor = below ? "rgba(130, 95, 60, 0.25)" :
    abundant ? "rgba(80, 160, 220, 0.3)" : "rgba(110, 180, 220, 0.2)";
  const labelColor = below ? "#7A5A38" : abundant ? "#4090D0" : "#5EA0C8";
    ...
    >
      ...
      <div style={{
        ...
        boxShadow: isSelected
          ? `0 0 0 3px ${labelColor}40, 0 0 20px ${glowColor}`
        ...
        <div style={{
          ...
          fontSize: baseW * 0.34, fontWeight: 700,
          color: value.score >= sm ? "rgba(255,255,255,0.9)" : "#2D2A26",
          textShadow: value.score >= sm ? "0 1px 4px rgba(0,0,0,0.3)" : "none",
          zIndex: 3,
        }}>
          {value.score}
        </div>
      ...
      {/* Name */}
      <div style={{
        fontSize: 10, fontWeight: 700, color: below ? "#C4504A" : "#2D2A26",
        textAlign: "center",
      }}>
        {value.name}
      </div>
      ...
      <div style={{
        ...
        color: below ? "#C4504A" : labelColor,
        background: (below ? "#C4504A" : labelColor) + "14",
    ...
    <div style={{
      ...
      <div style={{
        ...
        {actionModes.map(mode => (
          <div
            key={mode.key}
            onClick={() => setHoveredAction(mode.key === hoveredAction ? null : mode.key)}
            style={{
              padding: "5px 12px", borderRadius: 8,
              border: "1px solid #F0EDE6", background: "transparent",
              fontSize: 12, fontWeight: 600, color: "#2D2A26",
              cursor: "pointer", whiteSpace: "nowrap",
              transition: "all 0.15s ease",
            }}
            onMouseEnter={(e) => { e.currentTarget.style.background = "#FAFAF7"; e.currentTarget.style.borderColor = "#C4725A40"; }}
      ...
      <div style={{
        ...
        {/* Value pills — side by side: Protect | Expand */}
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 22,
            background: "rgba(130, 95, 60, 0.04)",
          }}>
            <div style={{
              fontSize: 8, fontWeight: 700, color: "#7A5A38", textTransform: "uppercase",
          ...
          {/* Vertical divider */}
          <div style={{
            width: 1, background: "#E8E4DC", alignSelf: "stretch",
            margin: "16px 4px",
          }} />
          ...
          <div style={{
            ...
            padding: "12px 20px 10px",
            borderRadius: 22,
            background: "rgba(110, 180, 220, 0.04)",
          }}>
            {expandValues.map(v => (
              <ValueOrb
                key={v.id} value={v}
            ...
            <div style={{
              fontSize: 8, fontWeight: 700, color: "#5EA0C8", textTransform: "uppercase",
